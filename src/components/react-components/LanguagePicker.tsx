    ...
    <div className="relative inline-block text-left" ref={ref}>
      <div>
        <button
          ...
          className="text-muted mr-2 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 inline-flex items-center"
          aria-expanded="true"
          aria-haspopup="true"
          onClick={toggleMenu}
        >
